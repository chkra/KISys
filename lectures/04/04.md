...
**Aufgabe (optional):** Wenn Sie wünschen, können Sie mit einem Notebook zur [Least Squares Demo](LeastSquaresDemo.ipynb) die Funktionsweise der linearen Regression im Code nachvollziehen.
{: .notice--info} 
